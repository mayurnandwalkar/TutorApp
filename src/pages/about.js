    ...
    return (
        <>
            ...
            <div class="about-area-two ptb-100">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-5 col-md-12">
                            <div class="about-content-box"><span class="sub-title">Learning From Tutor</span>
                ...
                <div class="shape2"><img src="assets/images/shape2.png" alt="image" /></div>
            </div>
            <div class="get-instant-courses-area-two bg-f9fbff">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-7 col-md-12">
                            <div class="get-instant-courses-content-style-two"><span class="sub-title">GET INSTANT ACCESS TO
                                THE FREE</span>
                        ...
                        <div class="col-lg-5 col-md-12">
                            <div class="get-instant-courses-image-style-two"><img src="assets/images/setting.png" alt="image" />
                            </div>
                        </div>
                    </div>
                </div>
